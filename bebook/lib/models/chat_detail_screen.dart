  ...
  Future<void> _fetchMessages() async {
    try {
      ...
      final response = await http
          .get(
            Uri.parse(
                "http://192.168.1.5:8000/messages/${widget.myId}/${widget.receiverId}/${widget.bookId}"),
          )
...
// WidgetsBinding kullanarak listenin g├╝ncellendi─şinden emin olup sonra kayd─▒r─▒yoruz
    ...
    try {
      final response = await http.post(
        Uri.parse("http://192.168.1.5:8000/messages/send"),
    ...
    return Padding(
      ...
      child: CircleAvatar(
        ...
        backgroundImage: (!isMe && imageUrl != null && imageUrl.isNotEmpty)
            ? NetworkImage(
                "http://192.168.1.5:8000${imageUrl.startsWith('/') ? imageUrl : '/$imageUrl'}")
            : null,
          ...
          children: [
            ...
            CircleAvatar(
              ...
              backgroundImage: (widget.receiverImage != null &&
                  ...
                  ? NetworkImage(
                      "http://192.168.1.5:8000/${widget.receiverImage!.replaceAll(r'\', '/')}")
                  : null,
