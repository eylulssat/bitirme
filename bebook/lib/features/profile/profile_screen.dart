      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("Profilini yönetmek için giriş yapmalısın.", textAlign: TextAlign.center),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(userDepartment ?? "Bölüm Belirtilmedi", style: const TextStyle(color: Colors.grey)),
                    Text(userUniversity ?? "Üniversite Belirtilmedi", style: const TextStyle(fontSize: 12, color: Colors.grey)),
                  ]
                ),
              ],
            ),
          ...
          const SizedBox(height: 30),
          _buildTile(Icons.favorite_border, "Favorilediğim Kitaplar", primaryColor, () => Navigator.push(context, MaterialPageRoute(builder: (context) => const FavoritesScreen()))),
          _buildTile(Icons.sell_outlined, "Satışa Sunduğum Kitaplar", primaryColor, () {}),
